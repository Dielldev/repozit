...
if (isset($_POST['register'])) {
    $name = $_POST['name'];
    $username = $_POST['email']; // Adjusted to match the HTML input name 'email'
    ...
    $check_query = "SELECT * FROM `sec1` WHERE `username`='$username'";
    ...
    $insert_query = "INSERT INTO `sec1` (`name`, `username`, `password`) VALUES ('$name', '$username', '$hashed_password')";
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <input type="submit" value="Register" name="register" class="btn btn-warning btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600; background-color: darkblue;" style="border-radius:25px; background-color: darkblue;" />

                    </div>

                  </form>
                  <p align="center">i have already account <a href="login1.php" class="text-warning" style="font-weight:600; text-decoration:none; color:darkblue;">Login</a></p>
                </div>
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                  <img src="img/draw1.webp" class="img-fluid" alt="Sample image" height="300px" width="500px">
