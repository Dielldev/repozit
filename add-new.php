...
if (isset($_POST["submit"])) {
	$name = encrypt($_POST['name'], $secret_key, $secret_iv);
	$card_number = encrypt($_POST['card_number'], $secret_key, $secret_iv);
	$expirity_date = $_POST['expirity_date']; // And this
	$cvv = $_POST['cvv']; // And this
...
<div class="payment-form-container">
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="payment-form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="cardholder-name" name="name" required>
			<p id="result"></p>
		</div>	
